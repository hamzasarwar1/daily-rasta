                   ...
                   <div dir="rtl" class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="section-tittle mb-40">
                                <h3 class="mt-5">ہمیں فالو کریں</h3>
                            </div>
                            <!-- Flow Socail -->
                                ...
                                <div class="single-box">
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="#"><img src="{{ asset('frontend/assets/img/news/icon-fb.png') }}" alt=""><b class="ml-3">فیس بک</b></a>
                                        </div>
                                    ...
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="#"><img src="{{ asset('frontend/assets/img/news/icon-tw.png') }}" alt=""><b class="ml-3">ٹویٹر </b></a>
                                        </div>
                                        <div class="follow-count">
                                            {{-- <span>8,045</span>
                                            <p>Fans</p> --}}
                                        ...
                                        <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="#"><img src="{{ asset('frontend/assets/img/news/icon-ins.png') }}" alt=""><b class="ml-3">انسٹاگرام</b></a>
                                        </div>
                                        <div class="follow-count">
                                            {{-- <span>8,045</span>
                                            <p>Fans</p> --}}
                                    ...
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="#"><img src="{{ asset('frontend/assets/img/news/icon-yo.png') }}" alt=""><b class="ml-3">یوٹیوب</b></a>
                                        </div>
                                        <div class="follow-count">
                                            {{-- <span>8,045</span>
                                            <p>Fans</p> --}}
