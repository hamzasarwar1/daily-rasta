                        ...
                        <div class="col-lg-4">
                            ...
                            @foreach ($recent_news as $item)
                                ...
                                <div class="media post_item">
                                    ...
                                    <img src="{{ asset('assets/postImages')."/".$item->feature_image }}" alt="{{ $item->title }}" style="height: 100px;width:100px;">
                                    &nbsp;
                                ...
                                ?>
                                    ...
                                    <div class="single-recent mb-100">
                                        ...
                                        <div class="what-cap">
                                            ...
                                            <h4 class="overflo" dir="rtl"><a href="{{ route('news.detail', [$item->slug]) }}">{{ $item->title }}</a></h4>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="{{ asset('frontend/assets/img/news/icon-ins.png') }}"
                                                alt=""><b class="ml-3">انسٹاگرام</b> </a>
                                    </div>
                                    <div class="follow-count">
